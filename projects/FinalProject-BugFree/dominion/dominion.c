...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        ...
        // fixes bug 2 by swapping the > to <
        ...
        for (i = 0; i < state->handCount[currentPlayer]; i++)
        {
            ...
            {
                // actually discards the card as opposed to keeping it in the played pile
    ...
    case tribute:
        ...
        for (i = 0; i < 2; i ++) {  // this is a bug here that should be where the tribute cards should be 0 and 1 indexs not 2 as well. // CHANGE_HERE
            ...
            // new if statement ignores the -1 case fixing bug 9
            else if ( tributeRevealedCards[0] == -1 || tributeRevealedCards[1] == -1)
                continue;
            else { //Action Card
                state->numActions = state->numActions + 2;
            }
    ...
    case ambassador:
        ...
        for (i = 0; i < state->handCount[currentPlayer]; i++)
        {
            // change the logic to state->hand[currentPlayer][i] for the second and third operand in the if statement fixed bug 10
