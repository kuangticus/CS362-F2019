...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case tribute:
      return case_tribute(currentPlayer, nextPlayer, state, tributeRevealedCards);
    case mine:
      return case_mine(currentPlayer, choice1, choice2, handPos, state);
    case adventurer:
